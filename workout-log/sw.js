...
const FILES=['./','./index.html','./css/styles.css','./js/icons.js','./js/config.js','./js/app.js?v=reset-enabled','./js/db.js','./js/workout.js','./js/export.js','./js/import.js','./js/backup.js','./manifest.webmanifest','./icons/icon.svg','./icons/apple-touch-icon.png','./icons/icon-192.png','./icons/icon-512.png'];
